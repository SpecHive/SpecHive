...
describe('ArtifactService', () => {
  ...
  describe('handleArtifactUpload', () => {
    ...
    it('stores a placeholder storagePath derived from runId, testId, and name', async () => {
      ...
      await service.handleArtifactUpload(event, PROJECT_ID, ORG_ID, mockTx as unknown as Database);
    ...
    it('throws NotFoundException when run belongs to a different project', async () => {
      ...
      await expect(
        service.handleArtifactUpload(event, PROJECT_ID, ORG_ID, mockTx as unknown as Database),
